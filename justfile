...
kotlin-multiplatform: ios ios-sim android jvm
    which gobley-uniffi-bindgen || cargo install --locked --bin gobley-uniffi-bindgen gobley-uniffi-bindgen@0.3.7
...
csharp-windows: build-bindings-lib
    which uniffi-bindgen-cs || cargo install --locked uniffi-bindgen-cs --git https://github.com/NordSecurity/uniffi-bindgen-cs --tag v0.10.0+v0.29.4
