...
impl Client {
    ...
    pub fn wallet_tx_details(
        &self,
        name: String,
        txid: String,
    ) -> Result<response::WalletTxDetails, Error> {
        let req = request::WalletTxDetails { name, txid };
        self.make_request(Method::WalletTxDetails, Some(req))
    }
