    ...
    pub(crate) fn schema(&self, direction: request::Direction) -> Result<Value, serde_json::Error> {
        serde_json::to_value(match direction {
            Direction::Request => match self {
                ...
                Method::WalletLiquidexMake => schema_for!(request::WalletLiquidexMake),
                Method::WalletLiquidexTake => schema_for!(request::WalletLiquidexTake),
            ...
            Direction::Response => match self {
                ...
                Method::WalletLiquidexMake => schema_for!(response::Pset),
                Method::WalletLiquidexTake => schema_for!(response::Pset),
...
impl FromStr for Method {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "wallet_liquidex_make" => Method::WalletLiquidexMake,
            "wallet_liquidex_take" => Method::WalletLiquidexTake,
...
impl std::fmt::Display for Method {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let s = match self {
            ...
            Method::WalletLiquidexMake => "wallet_liquidex_make",
            Method::WalletLiquidexTake => "wallet_liquidex_take",
