...
* [Custom store](./tests/bindings/custom_store.py) shows how the caller can persist wallet updates
* AMP0 [setup](./tests/bindings/amp0-setup.py) and [daily operations](./tests/bindings/amp0-daily-ops.py)
