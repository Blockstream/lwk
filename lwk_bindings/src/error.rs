...
#[cfg(feature = "simplicity")]
impl From<lwk_simplicity::taproot_pubkey_gen::TaprootPubkeyGenError> for LwkError {
    fn from(value: lwk_simplicity::taproot_pubkey_gen::TaprootPubkeyGenError) -> Self {
        LwkError::Generic {
            msg: format!("{value}"),
        }
    }
