...
builder = TxBuilder(network)
assert(str(builder) == "TxBuilder { network: ElementsRegtest { policy_asset: 5ac9f65c0efcc4775e0baec4ec03abdde22473cd3cf33c0419ca290e0751b225 }, addressees: [], fee_rate: 100.0, issuance_request: None }")

builder.fee_rate(200.0)
assert(str(builder) == "TxBuilder { network: ElementsRegtest { policy_asset: 5ac9f65c0efcc4775e0baec4ec03abdde22473cd3cf33c0419ca290e0751b225 }, addressees: [], fee_rate: 200.0, issuance_request: None }")
