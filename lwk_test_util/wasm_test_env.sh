...
ABANDON_ADDRESS=el1qq2xvpcvfup5j8zscjq05u2wxxjcyewk7979f3mmz5l7uw5pqmx6xf5xy50hsn6vhkm5euwt72x878eq6zxx2z0z676mna6kdq
$ELEMENTS_CLI_CMD sendtoaddress $ABANDON_ADDRESS 1
...
# Send to "abandon...about" address also an issued asset
ASSET_ID=$($ELEMENTS_CLI_CMD issueasset 10000 1 | jq -r .asset)
$ELEMENTS_CLI_CMD -named sendtoaddress address=$ABANDON_ADDRESS amount=1 assetlabel=$ASSET_ID
echo "Issued asset: $ASSET_ID"
