...
import {
  assertBytesEqual, assertEqual, assertNotNull, assertStringAndBytesRoundtrip,
} from "./scripts/assert-helpers.js";

const P2PK_SOURCE = readFileSync(join(__dirname, '../../../../../lwk_simplicity/data/p2pk.simf'), 'utf8');
...
export default async function runSimplicityP2pkTest() {
  try {
