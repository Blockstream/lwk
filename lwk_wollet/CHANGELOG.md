...
* Add Silent Payments (BIP-352 on Liquid, per the Liquid silent payments ELIP) behind the new default-on `silentpayments` feature, in module `lwk_wollet::silentpayments`:
