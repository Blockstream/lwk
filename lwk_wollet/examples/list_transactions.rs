...
use lwk_wollet::{
    full_scan_with_electrum_client, ElectrumClient, Network, WolletBuilder, WolletDescriptor,
};
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut wollet = WolletBuilder::new(Network::TestnetLiquid, descriptor).build()?;
