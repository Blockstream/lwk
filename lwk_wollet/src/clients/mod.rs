...
pub trait BlockchainBackend {
    ...
    fn full_scan<S: WolletStateTrait>(&mut self, state: &S) -> Result<Option<Update>, Error> {
    ...
    fn download_txs<S: WolletStateTrait>(
        &self,
    ...
    fn download_headers<S: WolletStateTrait>(
        &self,
...
mod tests {
    ...
    fn esplora_electrum_compare() {
        ...
        for (i, mut bb) in vec.into_iter().enumerate() {
            ...
            let first_update = bb.full_scan(&wollet.state()).unwrap().unwrap();
