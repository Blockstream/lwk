...
impl Verifier {
    ...
    fn verify_header(&self, header: &elements::BlockHeader) -> Result<(), Error> {
        ...
        match &header.ext {
            BlockExtData::Proof {
                ...
                for instr in solution
                    .instructions_minimal()
                    .chain(challenge.instructions_minimal())
                {
    ...
    fn process_op(
        ...
        if let Class::PushNum(val) = op.classify(ClassifyContext::Legacy) {
            ...
            let start = stack
                .len()
                .checked_sub(total_pubkeys)
                .ok_or_else(|| Error::InvalidHeaders)?;
            ...
            if verified == required_sig {
                info!(
                    "proof for block {} found {} valid signatures",
                    hash, verified
                );
...
mod test {
    ...
    #[test]
    fn test_regtest() {
        let regtest_header : elements::BlockHeader = deserialize(&hex::decode("").unwrap()).unwrap();
    ...
    fn test_liquid() {
        ...
        let mut genesis_header : elements::BlockHeader = deserialize(&hex::decode("").unwrap()).unwrap();
        ...
        // liquid block 1
        let block_header : elements::BlockHeader = deserialize(&hex::decode("").unwrap()).unwrap();
